...
function generateTKB($, selectorTKBTable, allTrs) {
    const tkb = [];
...
function generateEventFromTKB(tkb) {
...
function generateEventFromTkbHTML(tkbhtmlPath) {
    ...
    const tkb = generateTKB($, selectorTKBTable, allTrs);
    const finalResults = generateEventFromTKB(tkb);
    return finalResults;
}

const tkbhtmlPath = "tkbhk1.html";
console.log(generateEventFromTkbHTML(tkbhtmlPath));

module.exports = generateEventFromTkbHTML;
